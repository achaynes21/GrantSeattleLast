    ...
    public partial class AccountController : BaseMVCController
    {
        ...
        public virtual ActionResult SignIn(SignInViewModel model)
        {
            ...
            if (ModelState.IsValid)
                ...
                if (user.Role.Equals("Admin"))
                {
                    ...
                    return RedirectToAction("Index", "Client",new {page=1,roles="Admin"}); }
                else if (user.Role.Equals("Member")) { return RedirectToAction("Index", "Client", new { roles = "Member" }); }
        ...
        public ActionResult CreateAdmin()
        {
            try
            {
                ...
                member.Role = "Admin";
                member.Propertyses = new List<Propertys>();
                #region Check if email already exist
